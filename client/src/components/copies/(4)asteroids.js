...
// + asteroids move
// + projectile fire
// + collision detection: ship and asteroid, ship disappears on collision, game over screen
// + collision: if asteroids collide, they bounce off each other
// + if projectile hits asteroid, asteroid splits into two smaller asteroids

// REACT-SPRING ANIMATION SMOOTHING
